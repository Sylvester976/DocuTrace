...
<head>
    ...
    <title>Sign Up</title>
    <link rel="icon" href="{{ asset('images/docufav.ico')}}"><link href="{{ asset('docu-assets/style.css')}}" rel="stylesheet"></head>
<body
...
<!-- ===== Page Wrapper End ===== -->
<script defer src="{{ asset('docu-assets/bundle.js')}}"></script></body>
</html>
